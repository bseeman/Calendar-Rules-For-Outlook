   ...
   <table ID="table7" >
                        <tr>
                            ...
                            <td > 
							  ...
							  if ($_POST['boxTrigger'].$_POST['boxEvent'].$_POST['boxRule'].$_POST['boxRuleID'] == "" ) {
								  $checkall=1; 
								  } ?>
                            ...
                            <?php echo "<br />".$txtSearchErrormsg; ?></p></td>
                            <td > <p>	
                                <input name="btnSearchText" type="submit" value="Find" id="searchtextbutton" /> 
                                <a target= "_blank" href="http://www.calendarrules.com/SearchHelp.pdf">Search Help</a>
                          </p></td>
                        </tr>
...
//echo "MULTIPLE ITEMS!".is_array($theSearchResults[0]);
        ...
        </div><div id="tabs-2"><h2>Holidays</h2>
