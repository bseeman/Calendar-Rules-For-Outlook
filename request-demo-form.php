<?php
/*
Template Name: Request a Demo Form
 */
...
<form  id="quote_form" method="POST" action="procs/process_request_demo.php" class="widget">
    <h1 class="entry-title" style="float: left;">Request a Demo Form</h1>
    <div style="float: right;"><a href='request-a-demo'>Request a Demo</a></div>
    <br clear="all" />
