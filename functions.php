...
function add_loginout_link( $items, $args ) {
   // if ($_SESSION['userid']>0 && $args->theme_location == 'primary') {
     //   $items .= '<li id="myaccount"><a href="'. site_url('courts') .'">My Account</a></li>';
   // }
   // elseif (is_null($_SESSION['userid']) && $args->theme_location == 'primary') {
    //    $items .= '<li id="myaccount"><a href="'. site_url('subscribe') .'">Subscribe</a></li>';
   // }
   
           $items .= '<li id="myaccount"><a href="https://subscribe.docketlaw.com/subscribe?site=CRO">Subscribe</a></li>';
...
add_theme_support( 'genesis-custom-header', array( 'width' => 581, 'height' => 118 ) );
...
<!-- ui tabs with cookie to keep tab state of refresh -->
<script src="jquery/js/jquery.cookie.js" type="text/javascript"></script>
<script type="text/javascript">
    jQuery(document).ready(function() {
    jQuery( "#tabs" ).tabs({ cookie: { expires: 999, name: "#tabsCookie" }});
    });
</script>	
