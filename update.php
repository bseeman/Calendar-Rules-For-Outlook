...
<h1 class="entry-title">Checkout</h1>
              ...
              <form action="<?php echo $SSLDomain; ?>/procs/process_existing_payment.php" method="post">
              <h3>Order Summary</h3>
 <div class="widget"><table width="100%" align="center" class="widget-wrap">             
                ...
                <?php } while ($row_attornys_cart = mysql_fetch_assoc($attornys_cart)); ?><?php } // Show if recordset not empty ?>
      	            <tr>
      	              <td>&nbsp;</td>
      	              <td><div class="divider userinfo"></div><strong>
      	        ...
      	        <tr>
      	          <td align="center">&nbsp;</td>
      	          <td align="left" class="smallText"><br clear="all">
 ...
 <span class="checkboxRequiredMsg">Please agree to the terms &amp; conditions.</span></span></p>
<p>&nbsp;</p>
...
var sprycheckbox1 = new Spry.Widget.ValidationCheckbox("sprycheckbox1", {validateOn:["submit"]});
</script>
